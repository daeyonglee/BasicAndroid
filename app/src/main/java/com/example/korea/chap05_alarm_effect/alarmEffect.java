package com.example.korea.chap05_alarm_effect;
...
public class alarmEffect extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alarm_effect);
